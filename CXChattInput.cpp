...
void UCXChattInput::NativeConstruct()
{
...
void UCXChattInput::NativeDestruct()
{
...
void UCXChattInput::OnChatInputTextCommitted(const FText& Text, ETextCommit::Type CommitMethod)
{
